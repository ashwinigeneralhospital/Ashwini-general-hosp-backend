...
export const env = {
  ...
  HOSPITAL_LANDLINE: process.env.HOSPITAL_LANDLINE || '0251 260 33 88',
  HOSPITAL_FOOTER_ADDRESS:
    process.env.HOSPITAL_FOOTER_ADDRESS ||
    'ARJUN CO-OP SOCIETY,BAJI PRABHU DESHPANDE MARG,VADAVALI\nSECTION,AMBERNATH EAST - 421501',
